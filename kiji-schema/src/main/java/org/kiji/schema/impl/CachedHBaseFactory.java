...
@ApiAudience.Private
public final class CachedHBaseFactory implements HBaseFactory {
  ...
  /** {@inheritDoc} */
  @Override
  public LockFactory getLockFactory(KijiURI uri, org.apache.hadoop.conf.Configuration conf)
      throws IOException {
